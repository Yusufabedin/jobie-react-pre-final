                           ...
                           <div className="row">
                              <div className="col-4 p-0">
                                 <div className="d-inline-block mb-2 relative donut-chart-sale">
                                    <span
                                       className="donut"
                                       data-peity='{ "fill": ["rgb(255, 142, 38)", "rgba(236, 236, 236, 1)"],   "innerRadius": 27, "radius": 10}'
                                    >
                                       7/9
                                    </span>
                              ...
                              <div className="col-4 p-0">
                                 <div className="d-inline-block mb-2 relative donut-chart-sale">
                                    <span
                                       className="donut"
                                       data-peity='{ "fill": ["rgb(62, 168, 52)", "rgba(236, 236, 236, 1)"],   "innerRadius": 27, "radius": 10}'
                                    >
                                       4/9
                                    </span>
                              ...
                              <div className="col-4 p-0">
                                 <div className="d-inline-block mb-2 relative donut-chart-sale">
                                    <span
                                       className="donut"
                                       data-peity='{ "fill": ["rgb(34, 172, 147)", "rgba(236, 236, 236, 1)"],   "innerRadius": 27, "radius": 10}'
                                    >
                                       2/9
                                    </span>
