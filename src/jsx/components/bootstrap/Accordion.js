   ...
   return (
      <Fragment>
         ...
         <Row>
            ...
            <Col xl="6">
               <Card>
                  <Card.Header class="d-block card-header">
                     <Card.Title>Default Accordion</Card.Title>
                     <Card.Text class="m-0 subtitle">
                        ...
                        {defaultAccordion.map((d, i) => (
                           <div class="accordion__item" key={i}>
                              <Accordion.Toggle
                                 ...
                                 onClick={() => setActiveWithoutSpace(i)}
                              >
                                 <span className="accordion__header--text">
                                    {d.title}
                                 </span>
                        ...
                        {defaultAccordion.map((d, i) => (
                           <div class="accordion__item" key={i}>
                              <Accordion.Toggle
                                 ...
                                 onClick={() =>
                                    setActiveWithoutSpaceBordered(i)
                                 }
                              >
                                 <span className="accordion__header--text">
                                    {d.title}
                        ...
                        {defaultAccordion.map((d, i) => (
                           <div class="accordion__item" key={i}>
                              <Accordion.Toggle
                                 ...
                                 onClick={() =>
                                    setActiveIndicatorInLeftPosition(i)
                                 }
                              >
                                 <span className="accordion__header--text">
                                    {d.title}
                        ...
                        {defaultAccordion.map((d, i) => (
                           <div class="accordion__item" key={i}>
                              <Accordion.Toggle
                                 ...
                                 onClick={() => setActiveAccordionWithIcon(i)}
                              >
                        ...
                        {defaultAccordion.map((d, i) => (
                           <div class="accordion__item" key={i}>
                              <Accordion.Toggle
                                 ...
                                 onClick={() => setActiveAccordionHeaderBg(i)}
                              >
                                 <span className="accordion__header--icon"></span>
                                 <span className="accordion__header--text">
                                    {d.title}
                        ...
                        {defaultAccordion.map((d, i) => (
                           <div class="accordion__item" key={i}>
                              <Accordion.Toggle
                                 ...
                                 onClick={() => setActiveAccordionSolidBg(i)}
                              >
                                 <span className="accordion__header--icon"></span>
                                 <span className="accordion__header--text">
                                    {d.title}
                        ...
                        {defaultAccordion.map((d, i) => (
                           <div class="accordion__item" key={i}>
                              <Accordion.Toggle
                                 ...
                                 onClick={() =>
                                    setActiveAccordionActiveHeader(i)
                                 }
                              >
                                 <span className="accordion__header--icon"></span>
                                 <span className="accordion__header--text">
                        ...
                        {defaultAccordion.map((d, i) => (
                           <div class="accordion__item" key={i}>
                              <Accordion.Toggle
                                 ...
                                 onClick={() =>
                                    setActiveAccordionHeaderShadow(i)
                                 }
                              >
                                 <span className="accordion__header--icon"></span>
                                 <span className="accordion__header--text">
                        ...
                        {defaultAccordion.map((d, i) => (
                           <div class="accordion__item" key={i}>
                              <Accordion.Toggle
                                 ...
                                 onClick={() =>
                                    setActiveaccordionRoundedStylish(i)
                                 }
                              >
                                 <span className="accordion__header--icon"></span>
                                 <span className="accordion__header--text">
                        ...
                        {defaultAccordion.map((d, i) => (
                           <div class="accordion__item" key={i}>
                              <Accordion.Toggle
                                 ...
                                 onClick={() => setActiveAccordionGradient(i)}
                              >
                                 <span className="accordion__header--icon"></span>
                                 <span className="accordion__header--text">
                                    {d.title}
