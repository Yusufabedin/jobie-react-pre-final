...
const UiAlert = () => {
   ...
   useEffect(() => {
      setalertData(document.querySelectorAll(".alert"));
   }, []);
         ...
         <div class="row page-titles">
            <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item active">
                  <a href="javascript:void(0)">Alert</a>
               </li>
            </ol>
         </div>
         <div class="row">
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <div class="alert alert-info alert-dismissible fade show">
                        ...
                        <strong>Hey! Take a quick look.</strong>{" "}
                        <a href="#">My birthday party</a>
                     </div>
                     <div class="alert alert-warning alert-dismissible fade show">
                        <button
                           type="button"
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="alert alert-primary solid alert-dismissible fade show">
                        ...
                        <a
                           href="#"
                           class="badge badge-sm light badge-primary ml-1"
                        >
                           upgrade
                        </a>
                     </div>
                     <div class="alert alert-secondary solid alert-dismissible fade show">
                        ...
                        <a
                           href="#"
                           class="badge badge-sm light badge-secondary ml-1"
                        >
                           upgrade
                        </a>
                     </div>
                     <div class="alert alert-success solid alert-dismissible fade show">
                        ...
                        <a
                           href="#"
                           class="badge badge-sm light badge-success ml-1"
                        >
                           upgrade
                        </a>
                     </div>
                     ...
                     <div class="alert alert-info solid alert-dismissible fade show">
                        ...
                        <a
                           href="#"
                           class="badge badge-sm light badge-info ml-1"
                        >
                           upgrade
                        </a>
                     </div>
                     <div class="alert alert-warning solid alert-dismissible fade show">
                        ...
                        <a
                           href="#"
                           class="badge badge-sm light badge-warning ml-1"
                        >
                           upgrade
                        </a>
                     </div>
                     <div class="alert alert-danger solid alert-dismissible fade show">
                        ...
                        <a
                           href="#"
                           class="badge badge-sm light badge-danger ml-1"
                        >
                           upgrade
                        </a>
                     </div>
                     <div class="alert alert-dark solid alert-dismissible fade show">
                        ...
                        <a
                           href="#"
                           class="badge badge-sm light badge-dark ml-1"
                        >
                           upgrade
                        </a>
                     </div>
                     <div class="alert alert-light solid alert-dismissible fade show">
                        ...
                        <a
                           href="#"
                           class="badge badge-sm light badge-light ml-1"
                        >
                           upgrade
                        </a>
                     </div>
                     ...
                     <div class="row">
                        <div class="col-xl-6">
                           <div class="alert alert-primary notification">
                              <p class="notificaiton-title mb-2">
                                 <strong>Success!</strong> Vampires The Romantic
                        ...
                        <div class="col-xl-6">
                           <div class="alert alert-danger notification">
                              ...
                              <p>
                                 What is the loop of Creation? How is there
                                 something from nothing? In spite of the fact..{" "}
                              </p>
